              ...
              <div className="flex flex-col gap-5 mb-1">
                ...
                <div className="relative h-11 w-full min-w-[200px]">
                  <input
                    ...
                    required
                    className="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent !border-t-blue-gray-200 bg-transparent px-3 py-3 font-sans text-md font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:!border-t-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                  />
                ...
                <div className="relative h-11 w-full min-w-[200px]">
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option selected>Sign in as author or reader?</option>
                    <option value="author">Yes, I'm an Author</option>
                    <option value="reader">Yes, I'm a Reader</option>
                  </select>
                </div>
              </div>
